...
def get_shared_state():
    return {
        ...
        "results": {},
        "scores": defaultdict(int)  # Novo: Mantém pontuação dos usuários
    }
...
if shared_state["word"]:
    ...
    user_name = st.text_input("Seu nome:", key="user_name")  # Novo: Pede o nome do usuário
